...
\begin{figure}[htbp!]
 ...
 \end{figure}	    
 \begin{figure}[htbp!]
 \includegraphics[height=1\textheight]{code/MRLSBCG.png}
 \end{figure}
 \begin{figure}[htbp!]
 \includegraphics[height=1\textheight]{code/DiagonalCG.png}
 \end{figure}
\end {document}